...
<body class="text-center">
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<%
				List<EmployeeBean> list = (ArrayList<EmployeeBean>) request
						.getAttribute("empDetails");
			%>
				<div class="container">
			...
			<form class="form-inline" method="post" action="OIRSController">
				...
				<div class="form-group">
					...
					<h3>Resource requested by RM</h3>
					<br>
					...
					<h4>Number of Resource Assigned : ${numAssigned}</h4>
							...
							<table border="1px">
								...
								value="Assign Employee(s)" /> <br /></br> <input type="reset"
								class="btn btn-info" name="reset" value="Reset" /> <br /></br>
						</div>
						<!-- /card-container -->
					</div>
			</form>
