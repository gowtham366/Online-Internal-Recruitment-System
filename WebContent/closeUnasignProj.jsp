...
<title>CLose Unassign Project</title>
</head>
<body class="text-center">
	...
	<table border="1px" align="center">
		...
		<tr>
			...
			<td><%=endDate%></td>
			<td><a
				href="./OIRSController?action=closeProject&prjId=<%=prjBean.getProjectId()%>">
					<input type="button" value="Close" class="btn btn-info btn-lg">
			</a></td>
		</tr>
		<%
			}
