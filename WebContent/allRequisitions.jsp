...
<body class="text-center">
	...
	<table border="1px" align="center">
		...
		<tr>
			...
			<td><%=endDate%></td>
			<td><a
				href="./OIRSController?action=searchEmployee&reqId=<%=reqBean.getReqId()%>&domain=<%=reqBean.getReqDomain()%>&skill=<%=reqBean.getReqSkill()%>&numReq=<%=reqBean.getReqNoReq()%>&numAssigned=<%=reqBean.getNumAssigned() %>">
