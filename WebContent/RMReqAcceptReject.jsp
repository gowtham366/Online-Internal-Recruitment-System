...
<title>RM View Request response</title>
</head>
<body class="text-center">
	...
	<table border="1px" align="center">
		<tr>
			...
			<th>Domain</th>
			<th>Skill</th>
			<th>Number of Resource Requested</th>
			<th>Number of Resource Assigned</th>
			<th>Status</th>
			<th>Raised Date</th>
			<th>Closed Date</th>
			<th></th>
		...
		<tr>
			...
			<td><%=reqBean.getReqStatus()%></td>
			<td><%=reqBean.getReqDateCreated().substring(0,10)%></td>
			<%String dateClosed = reqBean.getReqDateClosed();
				if(dateClosed==null)
					dateClosed = "Not Closed";
				else
					dateClosed = dateClosed.substring(0,10);
			%>
			<td><%=dateClosed%></td>
			<td><a href="./OIRSController?action=getTaggedEmployees&reqId=<%=reqBean.getReqId()%>"><input
					type="button" value="View Response" class="btn btn-info btn-lg"></a></td>
		</tr>
		<%
			}
		%>
	...
	<%}else { %>
	<h3>
		<font color="red">No Requisition Raised</font>
	</h3>
	<%} %>
